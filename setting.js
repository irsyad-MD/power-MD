...
global.ownername = 'ɪᴍsʏᴅᴢᴢ' // Owner Name
global.owner = ['6285771756455'] // Nomor Owner
global.botname = 'ᴏғᴄ.sʏᴀᴅʙᴏᴛᴢ' // Nama Bot
// ====================== \\

// SETTING IN WM \\
global.packname = 'ᴏғᴄ.sʏᴀᴅʙᴏᴛᴢ' // Name Sticker
global.author = `ᴏғᴄ.sʏᴀᴅʙᴏᴛᴢ` // Name Sticker 
...
global.versi = '3.9.0'
global.gris = '`'
global.wm = `ᴏғᴄ.sʏᴀᴅʙᴏᴛᴢ` // Ubah Ae
global.namaStore = 'ᴏғᴄ.sʏᴀᴅʙᴏᴛᴢ' // Ubah Ae
global.ownerStore = 'ᴏғᴄ.sʏᴀᴅʙᴏᴛᴢ' // Ubah Ae
global.autobio = false // True Jika Langsung On False Jika Off
global.autoread = true // True Jika Langsung On False Jika On
global.thumbnail = 'https://files.catbox.moe/sri4cd.jpg'
// ====================== \\
